...
public class Lab604 {
		...
		public static void displayData(boolean stdIT, boolean subIT) {
			if(stdIT==true) {
				System.out.println("Student ID: "+studentId + " is 1st year student in IT");
			} else {
				System.out.println("Student ID: "+studentId + " is not 1st year student in IT");
			}
			if(subIT==true) {
				System.out.println("Enrolled in course for year 1");
			}
			else {
				System.out.println("Not enrolled in course for year 1");
			}
